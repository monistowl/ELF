...
% This here is a kit for gathering data from lab experiments that involve 
% multiple heterogeneous sources, like ECG and surveys. It is meant to be
% improved upon and added to, so fork away.

% For an interactive introduction to the framework, open ELF_demo.mlx
% You can also try the GUI apps:
% PhysioDataGui;
% EventDataGui;
% BehavDataGui;
% TaskGui;
